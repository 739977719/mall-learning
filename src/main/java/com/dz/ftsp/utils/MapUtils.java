...
import com.dz.ftsp.exception.ParamIllegalException;
import com.dz.ftsp.form.StringPaddingType;
...
public class MapUtils {
    ...
    public static List getListFromMapNotNull(Map<String,?> map, String fieldName){
        try{
            Object obj = getObjectFromMapNotNull(map, fieldName);
            return (List) obj;
        } catch (ParamIllegalException pe){
            throw pe;
        } catch (Exception e){
